...
<body>
	...
	<div class="header-container">
		...
		<nav class="navbar navbar-expand-lg bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="#" style="cursor:auto"> <img src="images/Admin.png" width="20%"> <b style="color: darkcyan;">Admin Panel</b> </a>
	...
	<div class="container-fluid" id="Add Candidate" style="padding: 40px;">
		<div class="row">
			<div class="col-sm-8">
				<h2 style="text-align: center; margin-left: 500px;"> <span style="background: mediumblue;color: whitesmoke;padding: 10px;border-radius: 10px;">Add Candidate for Election</span> </h2>
				<br><br><br>
				<hr/><br/>
				<div class="row">
					<div class="col-sm-6">
							...
							<tr>
								...
								<td>
									<div class="candidate-image-container">
										<img src="images/<?php echo $row['photo']; ?>" class="candidate-image" alt="Candidate Photo">
									</div>
								</td>
								<td>
